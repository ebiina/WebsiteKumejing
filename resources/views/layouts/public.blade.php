    ...
    <div class="bg-village-primary text-white py-2 text-sm">
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <div class="flex gap-6">
                <a href="https://wa.me/6285227161222" class="flex items-center gap-2 hover:text-village-accent transition">
                    <svg class="w-4 h-4 text-village-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                    </svg>
                    WhatsApp Desa
                </a>
                @auth
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 hover:text-village-accent transition">
                        <svg class="w-4 h-4 text-village-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @else
                    <a href="{{ route('login') }}" class="flex items-center gap-2 hover:text-village-accent transition">
                        <svg class="w-4 h-4 text-village-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
                ...
                <div class="flex gap-4">
                    <a href="https://www.instagram.com/kumejing_official/" target="_blank" class="w-10 h-10 bg-village-accent rounded-full flex items-center justify-center hover:opacity-80 transition cursor-pointer text-village-primary shadow-sm" title="Instagram Resmi Desa Kumejing">
            ...
            <div>
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-4 text-gray-300">
                        <svg class="w-5 h-5 text-village-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        <span class="text-sm">kumejingdesa25@gmail.com</span>
                    </div>
                    <div class="flex items-center gap-4 text-gray-300">
                        <svg class="w-5 h-5 text-village-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <span class="text-sm">+62 852-2716-1222</span>
                    </div>
                </div>
            </div>
        </div>
